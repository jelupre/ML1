...
опорным векторам, для которых ![lambda_i](https://github.com/jelupre/ML1/blob/master/images/lambda_i.png) не равно нулю. 
...
Ненулевыми ![lambda_i](https://github.com/jelupre/ML1/blob/master/images/lambda_i.png) обладают не только граничные опорные объекты, но и
