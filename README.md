...
<h2>Наивный	нормальный	байесовский	классификатор</h2>

<b>«Наивный» байесовский классификатор</b>. Будем полагать, что все объекты описываются n числовыми признаками. Обозначим через x = (ξ1, . . . , ξn)
произвольный элемент пространства объектов X = R
n, где ξj = fj (x).
Предположим, что все признаки f1, . . . , fn являются независимыми случайными величинами. Следовательно, функции правдоподбия классов представимы в виде
