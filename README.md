...
Рассмотрим функцию, которая подсчитывает потенциалы выборки относительно классифицируемой точки.
...
Теперь же посмотрим на функцию, которая определяет класс точки.
