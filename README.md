...
Теперь посмотрим, как выглядит карта классификации для данного алгоритма.

![LDF_map](https://github.com/jelupre/ML1/blob/master/images/LDF_map.png)

Взглянем на разделяющие линии классов.

![separating_lines](https://github.com/jelupre/ML1/blob/master/images/separating_lines.png)
