...
<b>«Наивный» байесовский классификатор</b>. Будем полагать, что все объекты описываются <i>n</i> числовыми признаками, то есть 
...
где множители - плотность распределений значений <i>j</i>-го признака для класса <i>y</i>.
